...
module.exports = async (
  ...
  if (cookies) {
    ...
    logger.info(
      "scrapedin",
      "email and password was provided, we're going to login..."
    );
  ...
  return {
    profileScraper: (url, waitMs) =>
      profile(browser, cookies, url, waitMs, hasToGetContactInfo),
    connectionScraper: waitMs => connections(browser, cookies, waitMs)
  };
};
